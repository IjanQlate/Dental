        ...
        <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Manage My Profile</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="phoneNo" id="phoneNo" value="<?php echo  strtoupper ($auth['phoneNo']); ?>" required>
                      </div> 
                    
                      <div class="col-6">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" name="email" id="email" value="<?php echo  $auth['email']; ?>" required>
                      </div>
                    </div> 
                  </div>
